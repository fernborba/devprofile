@extends('layouts.app', ['class' => 'login-page', 'page' => _('Lean Management'), 'contentClass' => 'login-page'])

@section('content')
    <div class="col-md-10 text-center ml-auto mr-auto">
        <h3 class="mb-5">Log in to start managing some projects.</h3>
    </div>
    <div class="col-lg-4 col-md-6 ml-auto mr-auto">
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                ...
                <div class="card-body">
                    <p class="text-dark mb-2">Sign in with <strong>test@test.com</strong> and the password <strong>123456789</strong></p>
